...
;
    .ORIG x4000
        .FILL STR1
        .FILL STR2
Str1    .STRINGZ "ayurkndsbi jknbrtuinb riaukidjai rbtkdafgrk vdrgbibseu askndjfsru idfijoujfh uisdiwpipk mnbvcxzaqw er"
STR2    .STRINGZ "hgdstyokmn bvcxzawedf rgyhgbhujh jijnmkikjh gfdcxszcdx ardxxwctat afvdytuoae fbubsavuru ebitgsftys hs"
    .END